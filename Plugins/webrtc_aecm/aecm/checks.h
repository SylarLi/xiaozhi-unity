 ...
 */
 ...
 #define RTC_CHECK_EQ(val1, val2) true
 #define RTC_CHECK_NE(val1, val2) true
 #define RTC_CHECK_LE(val1, val2) true
 #define RTC_CHECK_LT(val1, val2) true
 #define RTC_CHECK_GE(val1, val2) true
 #define RTC_CHECK_GT(val1, val2) true
 
 // The RTC_DCHECK macro is equivalent to RTC_CHECK except that it only generates
 // code in debug builds. It does reference the condition parameter in all cases,
 // though, so callers won't risk getting warnings about unused variables.
 #if RTC_DCHECK_IS_ON
 #define RTC_DCHECK(condition) true
 #define RTC_DCHECK_EQ(v1, v2) true
 #define RTC_DCHECK_NE(v1, v2) true
 #define RTC_DCHECK_LE(v1, v2) true
 #define RTC_DCHECK_LT(v1, v2) true
 #define RTC_DCHECK_GE(v1, v2) true
 #define RTC_DCHECK_GT(v1, v2) true
 #else
 #define RTC_DCHECK(condition) true
 #define RTC_DCHECK_EQ(v1, v2) true
 #define RTC_DCHECK_NE(v1, v2) true
